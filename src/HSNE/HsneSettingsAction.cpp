...
HsneSettingsAction::HsneSettingsAction(DualAnalysisPlugin* dualAnalysisPlugin) :
    //GroupAction(hsneAnalysisPlugin, "HSNE Settings", true),
    //_hsneAnalysisPlugin(hsneAnalysisPlugin),
    GroupAction(dualAnalysisPlugin, "HSNE Settings", true),
    _dualAnalysisPlugin(dualAnalysisPlugin),
    ...
    _topLevelScaleAction(this, _dualAnalysisPlugin, dualAnalysisPlugin->getHierarchy(), dualAnalysisPlugin->getInputDataset<Points>(), dualAnalysisPlugin->getOutputDataset<Points>(), &_tsneParameters)
{
