...
public:
     ...
     */
    HsneScaleAction(QObject* parent, DualAnalysisPlugin* plugin, HsneHierarchy& hsneHierarchy, Dataset<Points> inputDataset, Dataset<Points> embeddingDataset);

    HsneScaleAction(QObject* parent, DualAnalysisPlugin* plugin, HsneHierarchy& hsneHierarchy, Dataset<Points> inputDataset, Dataset<Points> embeddingDataset, TsneParameters* tsneParametersTopLevel);
    HsneScaleAction(QObject* parent, DualAnalysisPlugin* plugin, HsneHierarchy& hsneHierarchy, Dataset<Points> inputDataset, Dataset<Points> embeddingDataset, unsigned int scale);
...
private:
    DualAnalysisPlugin*     _dualAnalysisPlugin;
